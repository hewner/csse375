...
public class EmailReminder {
	...
	public EmailReminder(AppointmentModel appointments) {
	 ...
	 *             the exception
	 */
	static public void processDailyEmail(Calendar emailday)
			throws Exception {
		...
		EmailReminder reminder = new EmailReminder(AppointmentModel.getReference());
		reminder.sendEmail(host, addr, from, cal);
	...
	public void sendEmail(String host, String addr, String from,
		...
		Collection<Integer> l = appointments.getAppts(cal.getTime());
		if (l != null) {
			...
			for (Integer ik : l) {
					...
					appt = appointments.getAppt(ik.intValue());

...
public class PrecedentsTree extends DependencyTree {

	/**
	 * Creates a mew precedents tree.
	 * @param uiController the user interface controller
	 */
	public PrecedentsTree(UIController uiController) {
		super(uiController);
	}
	...
	public void selectionChanged(SelectionEvent event) {
		...
		if (event.isCellChanged())
			if (cell != null) {
				CellNode node = new PrecedentsNode(cell, treeModel, uiController);
				node.populate();
